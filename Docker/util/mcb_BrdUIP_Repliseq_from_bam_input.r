...
# ==============================================================================
# Script Name: MCB BrdUIP-Repliseq analysis
# Author:      Rawin Poonperm
# Date:        2026-02-13
# Version:     260213
#
# Description:
# Modified version of the BrdUIP w200k s40k analysis script.
# Updated to [include specification of bin sizes].
#
# Original Author: Hisashi Miura <hisashi.miura[at]riken.jp>
# Original Version: 210304 (BrdUIP w200k s40k analysis using AneuFinder)
# ==============================================================================
...
##################Run###########################
fragment_E=paste0(outdir_f,"/",name,"_EarlyS",ext)
fragment_L=paste0(outdir_f,"/",name,"_LateS",ext)
